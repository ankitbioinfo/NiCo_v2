                    ...
                    try:
                        ...
                        if savefigure:
                            if display_plot_as=='barplot':
                                gseapy.barplot(enr_res1.res2d,title=titlename1,ofname=finalsavename,fontsize=fontsize,size=circlesize,cmap = plt.cm.get_cmap(input_colormap))
                            ...
                            if display_plot_as=='barplot':
                                gseapy.barplot(enr_res1.res2d,title=titlename1,fontsize=fontsize,size=circlesize,cmap = plt.cm.get_cmap(input_colormap))
                            if display_plot_as=='dotplot':
...
umap_tag='X_umap',
msna=0.1,ms=5,cmap=plt.rcParams["image.cmap"],
...
visualize_factors_id,
umap_tag='X_umap',
quepath='./inputQuery/',msna=0.1,ms=5,cmap=plt.rcParams["image.cmap"],
saveas='pdf',transparent_mode=False,showit=True,figsize=(8,3.5)):
